"""Repository Integration — router.

GitHub App install/management; per-repo, read-only, scoped context fetch.
...
router = APIRouter(prefix="/v1/repository-integration", tags=["Repository Integration"])
