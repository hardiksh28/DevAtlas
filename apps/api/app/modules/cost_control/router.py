"""Cost & Abuse Control — router.

Operation-weighted budgets, caching, rate limiting, graceful degradation.
...
router = APIRouter(prefix="/v1/cost-control", tags=["Cost & Abuse Control"])
